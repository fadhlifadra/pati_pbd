    ...
    <aside id="leftsidebar" class="sidebar">
        ...
        <div class="user-info">
            ...
            <div class="info-container">
                ...
                @else
                    <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Employee Management INKA</div>
                    <div class="email">PT INKA (Persero)</div>
                    <div class="btn-group user-helper-dropdown">
                        <i class="material-icons" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">keyboard_arrow_down</i>
                        <ul class="dropdown-menu pull-right">
        ...
        <div class="menu">
            <ul class="list">
                ...
                <li {!! ($group == 'laporan') ? "class='active'" : "" !!}>
                    <a href="javascript:void(0);" class="menu-toggle">
                        <i class="material-icons">library_books</i>
                        <span>Data Maps</span>
                    </a>
                    <ul class="ml-menu">
                        <li {!! ($page == 'data_marker') ? "class='active'" : "" !!}>
                            <a href="{{ route('data_marker.index') }}">Tambah Marker</a>
                        </li>
